  ...
  <div>
    <el-card class="mb-4 box-card" shadow="never">
      <span>
        ...
        <br />
        我们采取了多项行业标准的安全技术和措施来保护你的信息。本站部署了有效的机制来防御常见的网络攻击，例如跨站脚本攻击（XSS）和SQL注入，以确保你与网站交互的安全性以及我们数据库的完整性。同时，本站使用HTTPS加密传输（SSL/TLS）来保护你的数据在传输过程中的机密性。本站试试安全有效的身份验证机制，全部HRM交互均通过HRM原生接口使用JWT
