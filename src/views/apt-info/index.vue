...
import { useGjgyRecords, GjgyRecord } from "./useGjgyRecords";
...
const form = ref<Partial<GjgyRecord>>({});
const recordDetail = ref<Partial<GjgyRecord>>({});
// 动态表单项 label 显示
...
// 新增/编辑对话框打开
function openDialog(mode: "add" | "edit", record?: GjgyRecord) {
  if (mode === "add") {
    isAddMode = true;
...
// 详情对话框
function showDetails(record: GjgyRecord) {
